...
<div class="FieldsTitle">بيانات المجمع</div>
			<form method="post" name="form1" action="<?php echo $editFormAction; ?>" data-validate="parsley">
				...
				<?php for($i1=0;$i1<$ug;$i1++){ ?>
					<option <?php if($row_RsEdarat['user_group']==$user_groups[$i1][0]) echo 'selected'; ?> value="<?php echo $user_groups[$i1][0];?>"><?php echo $user_groups[$i1][1];?></option>
				<?php } ?>
				</select>
				</div>
				...
				<div class="four columns">
					...
					<div>
						<label for="Sex_1"><input type="radio" name="sex" id="Sex_1" value="1" <?php if ($row_RsEdarat['sex']==1) {echo 'checked="checked"';} ?>  data-required="true">
						بنين</label>
						&nbsp; &nbsp; | &nbsp; &nbsp;
						<label for="Sex_0"><input type="radio" name="sex" id="Sex_0" value="0" <?php if ($row_RsEdarat['sex']==0) {echo 'checked="checked"';} ?>>
						بنات</label>
					</div>
				</div>
				<div class="four columns omega">
					...
					<div>
						<label for="hidden_1"><input type="radio" name="hidden" id="hidden_1" value="1" <?php if ($row_RsEdarat['hidden']==1) {echo 'checked="checked"';} ?>  data-required="true">
						ملغي</label>
						&nbsp; &nbsp; | &nbsp; &nbsp;
						<label for="hidden_0"><input type="radio" name="hidden" id="hidden_0" value="0" <?php if ($row_RsEdarat['hidden']==0) {echo 'checked="checked"';} ?>>
						فعال</label>
					</div>
				</div>
				<br class="clear">
