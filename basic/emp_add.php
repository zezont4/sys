...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($total_rows_if_exist > 0) {
        ...
        <div style="direction:rtl;text-align:center;font-size:22px;">
            ...
            <br/>
            <br/>
            <h1 dir="rtl" align="center">السجل المدني(<?php echo $row_if_exist['national_id']; ?>) موجود سابقا,وهو تابع <?php echo get_gender_label('emp', 'لل'); ?>
                :<?php echo $row_if_exist['full_name']; ?></h1>
            <h2 dir="rtl" align="center">قد يكون تابع <?php echo get_gender_label('e', 'ل'); ?> آخر ,لذا يرجى الاتصال بقسم الارتقاء ليقوم
                بنقل <?php get_gender_label('emp', 'ال'); ?></h2>
        </div>
        <?php
        exit;
    }
