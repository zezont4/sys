...
$StName1_Rs_St = Input::get('st_name1') ? "and StName1 LIKE'%" . Input::get('st_name1') . "%'" : ' ';
$StName2_Rs_St = Input::get('st_name2') ? "and StName2 LIKE'%" . Input::get('st_name2') . "%'" : ' ';
$StName3_Rs_St = Input::get('st_name3') ? "and StName3 LIKE'%" . Input::get('st_name3') . "%'" : ' ';
$StName4_Rs_St = Input::get('st_name4') ? "and StName4 LIKE'%" . Input::get('st_name4') . "%'" : ' ';
...
if ($user_group != 'edarh') {
    ...
    $query_Rs_St = sprintf("SELECT StID,Stfullname,arabic_name,HName,o_hide,`hide`,StEdarah,StHalaqah FROM view_0_students WHERE StEdarah = %s %s %s %s %s ORDER BY `hide`,arabic_name,HName,Stfullname", GetSQLValueString($user_id, "int"), $StName1_Rs_St, $StName2_Rs_St, $StName3_Rs_St, $StName4_Rs_St);
}
                        ...
                        <tr <?php if ($row_Rs_St["hide"] == 1) { ?> class='hidenRow' <?php ;
                            ...
                            <td>
                                ...
                                <?php if ($sex == 1 || $sex == 2) { ?>
                                    ...
                                    <hr>
                                    <a href="../mutqin/Register_add.php?StID=<?php echo $row_Rs_St['StID']; ?>" target="_blank">التسجيل ببرنامج متقن</a>
                                <?php } ?>
                            </td>
