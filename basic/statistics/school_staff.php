		...
		<table width="100%" cellspacing="0" cellpadding="0">
			...
			do { ?>
				<tr>
					...
					<td><?php echo $yes_no[$row_teachers['is_memorizing_quran']]; ?></td>
					<td><?php echo $yes_no[$row_teachers['has_tu7fah']]; ?></td>
					<td><?php echo $yes_no[$row_teachers['has_jazariah']]; ?></td>
					<td><?php echo $yes_no[$row_teachers['has_ejazah_in_quran']]; ?></td>
					<td><?php echo $yes_no[$row_teachers['has_ejazah_in_shatibiah']]; ?></td>
