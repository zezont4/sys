...
<div class="printButton">
    <form name="form1" method="get" action="#">
        <?php create_edarah_combo($EdarahID); ?>
...
<div class="reportWrapper">
    <div class="reportContent">
        <p class="report_description">احصائية بالمراحل الدراسية للطلاب والطالبات
            ...
            <br>
            <?php echo $EdarahID != null ? 'المجمع / الدار : ' . get_edarah_name($EdarahID) : null; ?>
        </p>
        <br>
...
WHERE st.StBurthDate BETWEEN $selected_level_start_berth_date AND $selected_level_end_berth_date AND st.hide=0 AND u.sex=1  $EdarahIDSql";
...
WHERE st.StBurthDate BETWEEN $selected_level_start_berth_date AND $selected_level_end_berth_date AND st.hide=0 AND u.sex=0  $EdarahIDSql";
