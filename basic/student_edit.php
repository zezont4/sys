...
mysqli_select_db($localhost, $database_localhost);
$query_RsStudent = sprintf("SELECT StName1,StName2,StName3,StName4,StID,StMobileNo,FatherMobileNo,guardian_name,StEdarah,StHalaqah,O_BurthDate,hide,school_level,nationality
		...
		<center>
			<form method="post" name="form1" action="<?php echo $editFormAction; ?>" data-validate="parsley">
				...
				<div class="five columns alpha">
					...
					<label>
						<input type="radio" name="RadioGroup1" value="0" id="RadioGroup1_0" data-required="true" <?php echo (int)$row_RsStudent['hide'] === 0 ? 'checked="checked"' : ''; ?> >
						مستمر في الدراسة
					</label>
					&nbsp;&nbsp;|&nbsp;&nbsp;
					<label>
