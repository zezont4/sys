...
<?php $PageTitle = 'طلب نقل ' . get_gender_label('st'); ?>
<?php if (login_check("edarh") == true) { ?>
    <?php
    ...
    $query_rs_transfer = sprintf("SELECT s.register_date,s.id, s.StName1,s.StName2,s.StName3,s.StName4,s.is_transferred,u_from.`arabic_name` transfer_from,u_to.`arabic_name` transfer_to FROM 0_student_transfer s 
