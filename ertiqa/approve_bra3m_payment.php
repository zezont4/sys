...
$PageTitle = 'اعتماد الصرف للبراعم';
...
//		if ($msg != '') {
            $query_RsMobile = sprintf("SELECT FatherMobileNo,edarah_sex,StName1,StName2,StName4,MarkName_Long,O_MurtaqaName,O_FinalExamDate,FinalExamDate,EdarahID  FROM view_er_ertiqaexams WHERE AutoNo = %s",
