...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = sprintf("update  er_bra3m set DarajahID=%s,SchoolLevelID=%s,Money=%s where AutoNo=%s",
        GetSQLValueString($_POST['DarajahID'], "int"),
        ...
        <div class="content">
            ...
            <div class="four columns alpha">
                ...
                <select class="FullWidthCombo" name="SchoolLevelID" id="SchoolLevelID" data-required="true">
                    ...
                    <?php $ii = 0;
                    do { ?>
                        <option value="<?php echo $ii ?>" <?php if ($ii == $SchoolLevelID) {
                            echo 'selected';
                        } ?>><?php echo $SchoolLevelName[$ii] ?></option>
                        <?php $ii++;
            ...
            <div class="four columns">
                ...
                <select class="FullWidthCombo" name="DarajahID" id="DarajahID" data-required="true">
                    ...
                    <?php $ii = 1;
                    do { ?>
                        <option value="<?php echo $ii ?>" <?php if ($ii == $DarajahID) {
                            echo 'selected';
                        } ?>><?php echo $bra3mName[$ii] ?></option>
                        <?php $ii++;
                    } while ($ii < 6); ?>
                </select>
            </div>
            <div class="four columns">
                ...
                <input name="DDate" type="text" id="DDate" value="<?php echo StringToDate($DDate); ?>" disabled>
            </div>
