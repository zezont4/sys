...
$Date1_Rs1 = Input::get('Date1') ? 'and DDate>=' . str_replace('/', '', Input::get('Date1')) : '';
$Date2_Rs1 = Input::get('Date2') ? 'and DDate<=' . str_replace('/', '', Input::get('Date2')) : '';
...
<?php do {
    ...
    if ($totalRows_st_count > 0) {
        ...
        <div class="reportContent">
            <p class="report_description">تفاصيل مكافأت سلم البراعم (<?php echo $row_edarat['arabic_name']; ?> ) خلال الفترة
