...
<?php do {
	...
	<div class="reportContent">
		<p class="report_description">تفاصيل حوافز <?php echo get_gender_label('e','ال') ?>  لـ ( <?php echo $row_edarat['arabic_name']; ?> )  خلال الفترة من <?php echo (($_GET['Date1']!='') ? $_GET['Date1'] : '(بداية النظام الإلكتروني في 1434/08/29 هـ)') ; ?> إلى <?php echo  (($_GET['Date2']!='') ? $_GET['Date2'] : '(تاريخ اليوم)') ; ?> </p>
