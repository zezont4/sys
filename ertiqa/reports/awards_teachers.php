...
<?php do {
    ...
    if ($totalRows_teacher_count > 0) {
        ...
        <div class="reportContent">
            <p class="report_description">تفاصيل جوائز <?php echo get_gender_label('ts', 'ال') ?> لـ ( <?php echo $row_edarat['arabic_name']; ?> ) خلال الفترة
            ...
            <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <!--				<th scope="col"><p>محفزات --><?php //echo get_gender_label('e','ال')
                    ?><!--</p></th>-->
                ...
                do {
                    ...
                    <tr>
                        ...
                        <!--				<td>--><?php //echo $row_teacher_money['sum_edarah'];
                        ?><!--</td>-->
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                    <?php $i++;
