...
<table>
	...
	<tr>
		...
		<td><?php if($row_RsEsh3ar['FinalExamDegree']>79) {echo get_array_1($murtaqaName,$row_RsEsh3ar['ErtiqaID']+1);} ?></td>
	</tr>
</table>
</div>
...
<li>
* حجز موعد آخر بعد مدة لا تقل عن (<strong>اسبوعين</strong>) . </li>
