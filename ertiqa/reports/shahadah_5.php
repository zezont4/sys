...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="sh_5_b.css">
...
<div id="HPageWrapper">
    ...
    <div id="containerDiv2">
        ...
        <div id="apDiv7">
            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><?php echo $row_Recordset1['Sora1Name'] ? $soraName[$row_Recordset1['Sora1Name']] : null; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora2Name'] ? $soraName[$row_Recordset1['Sora2Name']] : null; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora3Name'] ? $soraName[$row_Recordset1['Sora3Name']] : null; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora4Name'] ? $soraName[$row_Recordset1['Sora4Name']] : null; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora5Name'] ? $soraName[$row_Recordset1['Sora5Name']] : null; ?></td>
                </tr>
            </table>
        </div>
