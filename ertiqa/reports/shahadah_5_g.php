...
<div id="HPageWrapper">
    ...
    <div id="containerDiv2">
        ...
        <div id="apDiv7">
            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><?php echo $row_Recordset1['Sora1Name'] > 0 ? $soraName[$row_Recordset1['Sora1Name']] : ''; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora3Name'] > 0 ? $soraName[$row_Recordset1['Sora2Name']] : ''; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora3Name'] > 0 ? $soraName[$row_Recordset1['Sora3Name']] : ''; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora4Name'] > 0 ? $soraName[$row_Recordset1['Sora4Name']] : ''; ?></td>
                </tr>
                <tr>
                    <td><?php echo $row_Recordset1['Sora5Name'] > 0 ? $soraName[$row_Recordset1['Sora5Name']] : ''; ?></td>
                </tr>
            </table>
        </div>
