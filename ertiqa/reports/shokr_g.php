...
<div id="HPageWrapper">
	...
	<div class="FieldDiv" id="apDiv1"><?php echo get_gender_label('st','ال').'<span class="red_color">'.$row_Recordset1['O_StudentName'].'</span>'.' من '.'<span class="red_color">'.$row_Recordset1['O_Edarah'].'</span>'.' في حلقة  '.'<span class="red_color">'.$row_Recordset1['O_HName'].'</span>'; ?></div>
	<div class="FieldDiv" id="apDiv4"><?php echo  'لتفوقها في اختبار مرتقى  (  '.'<span class="red_color">'. $row_Recordset1['O_MurtaqaName'].'</span>'.' ) '.' وحصولها على درجة   ( '.'<span class="red_color ar">'.$row_Recordset1['FinalExamDegree'].'</span> )  '.' وتقدير  ( '.'<span class="red_color">'.$row_Recordset1['MarkName_Short'].'</span>'.' ) '.' في عام   '.'<span class="red_color ar">'.substr($row_Recordset1['FinalExamDate'],0,4).' هـ '.'</span>'; ?></div>
