...
VALUES
  (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
			...
			GetSQLValueString($_POST['Sora6Name'], "int"),
			GetSQLValueString(abs($_POST ['Sora6Discount']), "double"),
			GetSQLValueString($_POST ['Sora7Name'], "int"),
			GetSQLValueString(abs($_POST ['Sora7Discount']), "double"),
			GetSQLValueString($_POST['Sora8Name'], "int"),
			GetSQLValueString(abs($_POST ['Sora8Discount']), "double"),
			GetSQLValueString($_POST ['Sora9Name'], "int"),
			GetSQLValueString(abs($_POST ['Sora9Discount']), "double"),
			GetSQLValueString(abs($_POST['Sora10Name']), "int"),
			GetSQLValueString(abs($_POST['Sora10Discount']), "double"),
