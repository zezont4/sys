<?php
$sql = sprintf("SELECT * FROM ms_etqan_rgstr WHERE StID = %s", GetSQLValueString($student_id, "double"));
        ...
        <?php if ($rows_count > 0) { ?>
            <?php do { ?>
                ...
                <tr>
                    ...
                    <td><?php echo get_array_1($etqan_msbkh_type, $data['MsbkhID']); ?></td>
                    ...
                    <?php if ($logedInUser == true) { ?>
                        <td><a
                                href="../../etqan/Register_edit.php?auto_no=<?php echo $data['AutoNo']; ?>">تعديل</a>
                        </td><?php } ?>
                </tr>
