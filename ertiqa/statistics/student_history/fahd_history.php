<?php
$sql = sprintf("SELECT * FROM ms_fahd_rgstr WHERE StID = %s", GetSQLValueString($student_id, "double"));
        ...
        <?php if ($rows_count > 0) { ?>
            <?php do { ?>
                ...
                <tr>
                    ...
                    <td><?php echo get_array_1($fahd_MsbkhType, $data['MsbkhID']); ?></td>
                    ...
                    <?php if ($logedInUser == true) { ?>
                        <td><a href="../../fahd/Register_edit.php?auto_no=<?php echo $data['AutoNo']; ?>">تعديل</a>
                        </td><?php } ?>
                </tr>
