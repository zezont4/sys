...
<div class="four columns">
      <div class="LabelContainer">نوع المسابقة</div>
       <?php echo create_combo("MsbkhID",$etqan_msbkh_type,0,$row_RSetqanExam['MsbkhID'],'data-required="true"'); ?>
     </div>
    <div class="four columns omega">
      <div class="LabelContainer">تاريخ التسجيل</div>
      <input name="RDate" type="text" id="RDate" value="<?php echo StringToDate( $row_RSetqanExam['RDate']);?>" data-required="true" READONLY/>
	</div>
	      <br class="clear">
