...
if (isset($_POST['Date1'])) {
  if ($_POST['Date1']!=null) {$Date1_Rs1 = 'and f.RDate>=' . str_replace('/','',$_POST['Date1']);}
}
$Date2_Rs1 = "";
if (isset($_POST['Date2'])) {
  if ($_POST['Date2']!=null) {$Date2_Rs1 = 'and f.RDate<=' . str_replace('/','',$_POST['Date2']);}
}
...
<?php echo $PageTitle; ?>
  ...
  * يمكنك الاستعلام بالتاريخ الأول فقط أو الثاني فقط أو بالجميع
		...
		<?php if (isset($Date1_Rs1)) { ?>
			<div class="FieldsTitle">المسجلون في مسابقة الفهد خلال الفترة من <?php echo (($_POST['Date1']!='') ? $_POST['Date1'] : '(بداية النظام الإلكتروني في 1434/08/29 هـ)') ; ?> إلى <?php echo  (($_POST['Date2']!='') ? $_POST['Date2'] : '(تاريخ اليوم)') ; ?> </div>
			<?php } ?>
<table>
<tr>
	<td>الاسم</td>
