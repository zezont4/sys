...
$gender_labels = array(array('طالبة', 'طالب', 'st'), array('طالبات', 'طلاب', 'sts'), array('معلمة', 'معلم', 't'), array('معلمات', 'معلمين', 'ts'), array('دار', 'مجمع', 'e'), array('دور', 'إدارات', 'es'), array('المعلمة المختبرة', 'المعلم المختبر', 'mktbr'), array('مجتازات', 'مجتازون', 'najeh'), array('مستلمة', 'مستلم', 'mstlm'), array('مختبرات', 'مختبرون', 'mks'));
...
if ($SESSIOn_sex == 0) {
	$statusName = array(array("0", "الموعد لم يحدد"), array("1", "مقبولة"), array("2", "ناجحة"), array("3", "لم تجتز"), array("4", "غائبة"), array("5", "غائبة بعذر للطالبة"), array("6", "غائبة بعذر للدار"));
} else {
	$statusName = array(array("0", "الموعد لم يحدد"), array("1", "مقبول"), array("2", "ناجح"), array("3", "لم يجتز"), array("4", "غائب"), array("5", "غائب بعذر للطالب"), array("6", "غائب بعذر للمجمع"));
}

$murtaqaName = array(array("", "حدد المرتقى..."), array("1", "الملك"), array("2", "ق"), array("3", "الزمر"), array("4", "النمل"), array("5", "الكهف"), array("6", "يونس"), array("7", "المائدة"), array("8", "الفاتحة"), array("9", "برنامج المهرة"),);

$bra3mName = array("Null"                /* 0 */, "القارعة"                /* 1 */, "البلد"                    /* 2 */, "المطففين"                /* 3 */, "النبأ"                /* 4 */, "الجن"                /* 5 */, "مرتقى الملك"                /* 6 */);

$murtaqaEndSora = array(0                  /*-*/, 67                /*الملك*/, 50                /*ق*/, 39                /*الزمر*/, 27                /*المنل*/, 18                /*الكهف*/, 10                /*يونس*/, 5                 /*المائدة*/, 1                 /*الفاتحة*/);
...
$SchoolLevelName = array("غير ملتحق"                /* 0 */, "روضة"                /* 1 */, "تمهيدي"                    /* 2 */, "أول ابتدائي"                /* 3 */, "ثاني ابتدائي"                /* 4 */, "ثالث ابتدائي"                /* 5 */);

$SchoolLevelNameAll = array(array("", "حدد السنة الدراسية..."), array("0", "أول ابتدائي"), array("1", "ثاني ابتدائي"), array("2", "ثالث ابتدائي"), array("3", "رابع ابتدائي"), array("4", "خامس ابتدائي"), array("5", "سادس ابتدائي"), array("6", "أول متوسط"), array("7", "ثاني متوسط"), array("8", "ثالث متوسط"), array("9", "أول ثانوي"), array("10", "ثاني ثانوي"), array("11", "ثالث ثانوي"), array("12", "جامعي"));

$MsbkhType = array(array("", "حدد نوع المسابقة..."), array("7", "حلقات"), array("0", "جزأين (دنيا)"), array("1", "جزأين (عليا)"), array("2", "خمس أجزاء"), array("3", "عشرة أجزاء"), array("4", "عشرون جزءاَ"), array("5", "القرآن كاملا"), array("6", "مزامير آل داود"), array("8", "أصغر حافظ"));

$etqan_msbkh_type = array(array("2", "15 جزءَا ثانوي"), array("4", "15 جزءَا متوسط"), array("9", "جزأين ابتدائي"), array("", "حدد نوع المسابقة..."), array("10", "القرآن الكريم مع التفسير"), array("0", "القرآن الكريم كاملا"), array("1", "20 جزءَا ثانوي فما فوق"), array("3", "10 أجزاء ثانوي فما فوق"), array("5", "10 أجزاء متوسط"), array("6", "5 أجزاء متوسط"), array("7", "10 أجزاء ابتدائي"), array("8", "5 أجزاء ابتدائي"),);

$shabab_msbkh_type = array(array("", "حدد نوع المسابقة..."), array("0", "20 جزءَا"), array("1", "10 أجزاء"), array("2", "5 أجزاء"),);

//	نوع المتسابقة
$MtsabikType = array(array("0", 'أساسي'), array("1", 'احتياط'));
