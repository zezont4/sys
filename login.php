...
<head>
    ...
    <link rel="icon" type="image/ico" href="<?php echo ROOT; ?>/_images/favicon/favicon.ico">
...
?>
    ...
    <form name="login-form" id="form1" class="login-form" method="POST" action="secure/process_login.php" data-validate="parsley">
        ...
        <div class="content">
            ...
            <input name="password" type="password" class="input password" placeholder="كلمة المرور" data-required="true"/>
