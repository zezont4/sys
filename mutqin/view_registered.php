...
<?php $PageTitle = 'الطلاب المسجلون في برنامج متقن'; ?>
...
ORDER BY EdarahID,MsbkhID,HalakahID",
    ...
    <div class="content CSSTableGenerator">
        <?php if (isset($Date1_Rs1)) { ?>
            <div class="FieldsTitle">المسجلون في برنامج متقن <?php echo((Input::get('Date1') == '' && Input::get('Date2') == '') ? ' ( ' . $_SESSION ['default_year_name'] . ' ) ' : ''); ?>
                خلال الفترة
        ...
        <table>
            ...
            <?php if ($totalRows_ReRegistered > 0) { // Show if recordset not empty ?>
                ...
                do { ?>
                    <tr>
                        ...
                        <td><?php echo get_array_1($mutqin_msbkh_type, $row_ReRegistered['MsbkhID']); ?></td>
            ...
            <?php } else { ?>
                <td colspan="7">لايوجد طلاب مسجلون في برنامج متقن حسب التاريخ المحدد</td>
            <?php } ?>
        </table>
    </div>
    <div id="printButton">
