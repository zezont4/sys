...
<?php $PageTitle = 'تعديل بيانات '.get_gender_label('st','').' في مسابقة رعاية الشباب'; ?>
...
<div class="content">
	...
	<div class="four columns alpha">
       ...
       <?php echo create_combo("SchoolLevelID",$SchoolLevelNameAll,0,$row_RSshababExam['SchoolLevelID'],'data-required="true"'); ?>
    	</div>
...
<div class="four columns">
    ...
    <div class="four columns omega">
      ...
      <input name="RDate" type="text" id="RDate" value="<?php echo StringToDate( $row_RSshababExam['RDate']);?>" data-required="true" READONLY/>
	</div>
	      <br class="clear">
...
<!-- closed -->
<?php }else{echo '<p class="WrapperMSG" >'. 'عفوا .. انتهت فترة التسجيل في مسابقة الفهد (حلقات)'.'</p>';} ?>
