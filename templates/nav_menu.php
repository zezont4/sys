<nav id="menu">
    <ul>
        ...
        <li class="admin edarh t3lem ms"><span>مسابقات</span>
            <ul>
                ...
                <li class="admin edarh ms"><a href="/sys/shabab/view_registered.php" tabindex="-1">المسجلون في رعاية الشباب</a></li>
                <li class="admin ms"><a href="/sys/shabab/view_registered_2_access.php" tabindex="-1">المسجلون في رعاية الشباب (ACCESS)</a></li>
